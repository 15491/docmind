...
-- AddForeignKey
ALTER TABLE "ChatSession" ADD CONSTRAINT "ChatSession_knowledgeBaseId_fkey" FOREIGN KEY ("knowledgeBaseId") REFERENCES "KnowledgeBase"("id") ON DELETE CASCADE ON UPDATE CASCADE;
